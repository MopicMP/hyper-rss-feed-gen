...
[![PyPI version](https://badge.fury.io/py/hyper-rss-feed-gen.svg)](https://pypi.org/project/hyper-rss-feed-gen/)
...
```bash
pip install hyper-rss-feed-gen
```

## Quick Start

```python
from hyper_rss_feed_gen import gen
...
from hyper_rss_feed_gen import batch
